#include <stdlib.h>
byte motor1 = 3, motor2 = 5, motor3 = 6, motor4 =9 , echo = 10 , trig = 11 ,x=0,RS=7, LS=2, MS =4, left = 0, right = 0 , med = 0,pr=1,pl=1,pm=1 ,  d = 0;
   ...
   /* if (current == 'z') // dh l character ly hygyly wly 
    {
      ...
      timer = millis()*10^(-3);
      Forward();
       if (( .48 * timer ) <= result ) // l mfrod a3ml relation ben l sor3a wl time 34an azbt l distance
     {  Stop(); break;}
      }
   }*/
